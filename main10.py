...
num_players=1
personajes_elegidos=[]
CONTROLES_JUGADOR_1 = [pygame.K_UP, pygame.K_DOWN, pygame.K_LEFT, pygame.K_RIGHT]
CONTROLES_JUGADOR_2 = [pygame.K_w, pygame.K_s, pygame.K_a, pygame.K_d]
# Inicializar Pygame
pygame.init()
