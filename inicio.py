...
def pantalla_de_inicio():
    ...
    fondo = pygame.transform.scale(pygame.image.load("Imagenes y demas descargas/Turbo Track.png"), (largo, alto))
    ...
    while True:
        ...
        renderizar_texto_con_contorno("Press any key to continue", fuente, colores[indice_color], blanco, (largo // 2, alto - 50))
        pygame.display.flip()
        clock.tick(60)
def pantalla_eleccion_modo():
    ...
    opciones = [
        ...
        {"texto": "3. computer", "posicion": (largo // 2, (alto // 2 + 50)+35)},
    ]
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_w:  
                    pantalla_de_carga_personaje('colapinto.png', (173, 216, 230), (0, 0, 128), 'Williams')
                elif event.key == pygame.K_r: 
                    pantalla_de_carga_personaje('red bull.png', (255, 0, 0), (0, 0, 255), 'Red Bull')
                elif event.key == pygame.K_f:  
                    pantalla_de_carga_personaje('ferrari.png', (0, 255, 0), (128, 0, 128), 'Ferrari')
                elif event.key == pygame.K_m:
                    pantalla_de_carga_personaje('mclaren.png', (0,255,255), (0,255,255), 'Mc Laren')
                return 
