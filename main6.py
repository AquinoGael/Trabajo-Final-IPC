...
# Variable para mantener el estado de la ejecución de Pygame
running = True
...
def pantalla_eleccion_personaje(num_players):
    ...
    if not pygame.get_init() or not running:
        return
